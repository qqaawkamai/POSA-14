    ...
    public int onStartCommand(final Intent intent,
        ...
        Runnable downloadRunnable = new Runnable() {
			...
			public void run() {
				...
				Messenger message = (Messenger) intent.getExtras().get(DownloadUtils.MESSENGER_KEY);
				DownloadUtils.downloadAndRespond(getApplicationContext(), intent.getData(), message);
